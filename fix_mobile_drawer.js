...
const targetOld = `        {/* Mobile Nav Drawer */}
        {mobileOpen && (
...
const replaceNew = `        {/* Mobile Nav Drawer Overlay */}
        <div 
...
if (content.includes(targetOld) && content.includes(targetTopOld)) {
  ...
  if (!content.includes(targetOld)) console.log("Missing targetOld");
  if (!content.includes(targetTopOld)) console.log("Missing targetTopOld");
}
