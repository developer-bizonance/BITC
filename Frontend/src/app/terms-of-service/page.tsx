    ...
    <div className="min-h-screen bg-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-sm border border-slate-200/80 p-8 sm:p-12">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900">Terms of <span className="text-transparent bg-clip-text bg-[linear-gradient(to_right,#ffcc00_0%,#ff9900_100%)]">Service</span></h1>
        </div>
        ...
        <div className="space-y-6 text-slate-700 leading-relaxed text-sm sm:text-base">
          ...
          <h2 className="text-xl font-bold text-slate-900 pt-4">User <span className="text-transparent bg-clip-text bg-[linear-gradient(to_right,#ffcc00_0%,#ff9900_100%)]">Responsibilities</span></h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-slate-900 pt-4">Intellectual <span className="text-transparent bg-clip-text bg-[linear-gradient(to_right,#ffcc00_0%,#ff9900_100%)]">Property</span></h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-slate-900 pt-4">Contact <span className="text-transparent bg-clip-text bg-[linear-gradient(to_right,#ffcc00_0%,#ff9900_100%)]">Information</span></h2>
          <p>
